...
Snake::Snake(int top_X, int top_Y, int bot_X, int bot_Y, int _tamanho, float mutationRate){
	cerebro=new RedeNeural(10, 4, {64}, mutationRate);
...
void Snake::movimentar(int a, int b){
    ...
    entradas->multiplicar_escalar(3);
